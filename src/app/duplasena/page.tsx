...
import { ChartDuplasenaOverview } from "@/components/chartDuplasena";
...
export default function Home() {
  ...
  useEffect(() => {
    async function loadLoterias() {
      try {
        const API_URL_MEGASENA = "https://loteriascaixa-api.herokuapp.com/api/duplasena";
  ...
  return (
    ...
    <h1 className="m-3" >DUPLA-SENA</h1>
    <p className="m-3" >Dezenas : 01 - 50 </p>
      ...
      <ChartDuplasenaOverview data={chartData} />
    </main>
  );
}
